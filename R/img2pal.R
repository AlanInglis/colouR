...
#' @param noCols Integer. The number of most frequent colours in input image to consider.
#' @param avgCols Logical. Whether to average colours within clusters.
#' @param exclude Character vector. List of colors in HEX format to exclude from the palette.
#' @param nClust Integer. The number of clusters for colour grouping.
#'
